...
$(document).ready(function(){
  $(".product-feature p").click(function(){
    $(".product-feature-none").css("display","block")
    $(".product-feature p").css("display","none")
  })
})
$(document).ready(function(){
  $(".custom-des-product-conti").click(function(){
    $(".custom-des-product-none").css("display","block")
    $(".custom-des-product-feature-none").css("display","block")
    $(".custom-des-product-cloth").css("display","block")
    $(".custom-des-product-conti").css("display","none")
    $(".custom-des-product-a").css("display","none")
  })
})
$(document).ready(function(){
  $(".custom-des-product-cloth").click(function(){
    $(".custom-des-product-none").css("display","none")
    $(".custom-des-product-feature-none").css("display","none")
    $(".custom-des-product-cloth").css("display","none")
    $(".custom-des-product-conti").css("display","block")
    $(".custom-des-product-a").css("display","block")
  })
})

$(document).ready(function(){
  $(".comment-btn-answer-1").click(function(){
    $(".comment-answer-1").css("display","block")
    $(".comment-btn-answer-1").css("display","none")
  })
})
$(document).ready(function(){
  $(".comment-btn-answer-2").click(function(){
    $(".comment-answer-2").css("display","block")
    $(".comment-btn-answer-2").css("display","none")
  })
})
